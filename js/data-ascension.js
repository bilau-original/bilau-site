...
const AscensionData = {
  ...
  heavenlyUpgrades: [
    // ──── TIER 1: Básicas (custo 1-25 CT) ────
    {
      ...
      icon: '🧬',
      desc: '+5% cm/s permanente por nível de prestígio.',
      cost: 1,
    ...
    },
    {
      ...
      icon: '🧬',
      desc: '+10% cm/s permanente por nível de prestígio.',
      cost: 50,
    ...
    },
    {
      ...
      icon: '🧬',
      desc: '+20% cm/s permanente por nível de prestígio.',
      cost: 100,
    ...
    },
    {
      ...
      icon: '🌙',
      desc: 'Produção offline sobe de 50% para 75% do cm/s.',
      cost: 100,
    ...
    },
    {
      ...
      icon: '💉',
      desc: '+50% cm/s permanente por nível de prestígio.',
      cost: 1000,
    ...
    },
    {
      ...
      icon: '💪',
      desc: 'cm/s global ×3. Sim, triplica tudo.',
      cost: 5000,
    ...
    },
    {
      ...
      name: 'Sonâmbilau',
      icon: '😴',
      desc: 'Produção offline sobe para 100% do cm/s. Cresce até dormindo!',
      cost: 5000,
      effect: { type: 'offline_pct', value: 0.25 },
      req: 'hv_offline1',
    },
    ...
    },
    {
      ...
      icon: '🧬',
      desc: '+100% cm/s permanente por nível de prestígio.',
      cost: 10000,
    ...
    },
    {
      ...
      icon: '�',
      desc: 'cm/s global ×5. Quintuplicar é estilo de vida.',
      cost: 25000,
    ...
    },
    {
      ...
      name: 'O Bilau Eterno',
      icon: '✴️',
      desc: 'cm/s global ×10. Prestígio rende +100% CT. O ápice.',
      cost: 50000,

...
const EvolutionsData = [
  // ──────── FASE 1: O COMEÇO HUMILDE (evo 1-5) ────────
  {
    ...
    icon: 'assets/evolutions/1.png', asset: 'assets/evolutions/1.png', placeholder: '🍆',
    threshold: 0,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/2.png', asset: 'assets/evolutions/2.png', placeholder: '🥒',
    threshold: 1000,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/3.png', asset: 'assets/evolutions/3.png', placeholder: '🌽',
    threshold: 50000,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/4.png', asset: 'assets/evolutions/4.png', placeholder: '🥖',
    threshold: 500000,
  ...
  {
    id: 'evo5', name: 'Bilão',
    icon: 'assets/evolutions/5.png', asset: 'assets/evolutions/5.png', placeholder: '🥖',
    threshold: 5000000,
  ...
  // ──────── FASE 2: GANHANDO RESPEITO (evo 6-10) ────────
  {
    ...
    icon: 'assets/evolutions/6.png', asset: 'assets/evolutions/6.png', placeholder: '🥖',
    threshold: 50000000,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/7.png', asset: 'assets/evolutions/7.png', placeholder: '🥖',
    threshold: 500000000,
  ...
  {
    id: 'evo8', name: 'Bilorc',
    icon: 'assets/evolutions/8.png', asset: 'assets/evolutions/8.png', placeholder: '🗿',
  ...
  },
  {
    ...
    icon: 'assets/evolutions/9.png', asset: 'assets/evolutions/9.png', placeholder: '🏠',
  ...
  },
  {
    ...
    icon: 'assets/evolutions/10.png', asset: 'assets/evolutions/10.png', placeholder: '🏗️',
  ...
  // ──────── FASE 3: ESCALA GEOGRÁFICA (evo 11-15) ────────
  {
    ...
    icon: 'assets/evolutions/11.png', asset: 'assets/evolutions/11.png', placeholder: '🗺️',
    threshold: 5e12,
  ...
  {
    id: 'evo12', name: 'Biluu',
    icon: 'assets/evolutions/12.png', asset: 'assets/evolutions/12.png', placeholder: '🌍',
    threshold: 5e13,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/13.png', asset: 'assets/evolutions/13.png', placeholder: '✈️',
    threshold: 5e14,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/14.png', asset: 'assets/evolutions/14.png', placeholder: '🌐',
    threshold: 5e15,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/15.png', asset: 'assets/evolutions/15.png', placeholder: '☁️',
    threshold: 5e16,
  ...
  // ──────── FASE 4: ESCALA ASTRONÔMICA (evo 16-20) ────────
  {
    ...
    icon: 'assets/evolutions/16.png', asset: 'assets/evolutions/16.png', placeholder: '🛸',
    threshold: 5e17,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/17.png', asset: 'assets/evolutions/17.png', placeholder: '🌙',
    threshold: 5e18,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/18.png', asset: 'assets/evolutions/18.png', placeholder: '🪐',
    threshold: 5e19,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/19.png', asset: 'assets/evolutions/19.png', placeholder: '☀️',
    threshold: 5e21,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/20.png', asset: 'assets/evolutions/20.png', placeholder: '⭐',
    threshold: 5e23,
  ...
  // ──────── FASE 5: ESCALA GALÁCTICA (evo 21-25) ────────
  {
    ...
    icon: 'assets/evolutions/21.png', asset: 'assets/evolutions/21.png', placeholder: '🌫️',
    threshold: 5e25,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/22.png', asset: 'assets/evolutions/22.png', placeholder: '🌌',
    threshold: 5e27,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/23.png', asset: 'assets/evolutions/23.png', placeholder: '💫',
    threshold: 5e29,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/24.png', asset: 'assets/evolutions/24.png', placeholder: '🕸️',
    threshold: 5e32,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/25.png', asset: 'assets/evolutions/25.png', placeholder: '🕳️',
    threshold: 5e35,
  ...
  // ──────── FASE 6: ESCALA UNIVERSAL (evo 26-30) ────────
  {
    ...
    icon: 'assets/evolutions/26.png', asset: 'assets/evolutions/26.png', placeholder: '🔭',
    threshold: 5e38,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/27.png', asset: 'assets/evolutions/27.png', placeholder: '🔮',
    threshold: 5e42,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/28.png', asset: 'assets/evolutions/28.png', placeholder: '🪞',
    threshold: 5e46,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/29.png', asset: 'assets/evolutions/29.png', placeholder: '🌀',
    threshold: 5e50,
    description: '...',
    bonusMult: 2.0,
  },
  {
    ...
    icon: 'assets/evolutions/30.png', asset: 'assets/evolutions/30.png', placeholder: '♾️',
    threshold: 5e55,
  ...
  // ──────── FASE 7: ALÉM DA FÍSICA (evo 31-35) ────────
  {
    ...
    icon: 'assets/evolutions/31.png', asset: 'assets/evolutions/31.png', placeholder: '⏳',
    threshold: 5e60,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/32.png', asset: 'assets/evolutions/32.png', placeholder: '💭',
    threshold: 5e65,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/33.png', asset: 'assets/evolutions/33.png', placeholder: '🧠',
    threshold: 5e70,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/34.png', asset: 'assets/evolutions/34.png', placeholder: '📐',
    threshold: 5e75,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/35.png', asset: 'assets/evolutions/35.png', placeholder: '🧮',
    threshold: 5e80,
  ...
  // ──────── FASE 8: ESCALA DIVINA (evo 36-40) ────────
  {
    ...
    icon: 'assets/evolutions/36.png', asset: 'assets/evolutions/36.png', placeholder: '📜',
    threshold: 5e85,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/37.png', asset: 'assets/evolutions/37.png', placeholder: '👼',
    threshold: 5e90,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/38.png', asset: 'assets/evolutions/38.png', placeholder: '🌅',
    threshold: 5e95,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/39.png', asset: 'assets/evolutions/39.png', placeholder: '🔱',
    threshold: 5e100,
  ...
  },
  {
    ...
    icon: 'assets/evolutions/40.png', asset: 'assets/evolutions/40.png', placeholder: '✴️',
    threshold: 5e110,
